-- =====================================================
-- COMPLETE SUBSCRIPTION & PAYMENT SYSTEM MIGRATION
-- Run this ONCE in Supabase SQL Editor
-- =====================================================
-- This creates all tables, functions, and policies needed
-- for the subscription and payment management system
-- =====================================================
...
-- Create unique index for active subscriptions (partial index)
CREATE UNIQUE INDEX IF NOT EXISTS unique_active_subscription_per_merchant 
...
-- =====================================================
-- 3. CREATE STORAGE BUCKET FOR PAYMENT SCREENSHOTS
-- =====================================================
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    AND policyname = 'Users can upload payment screenshots'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'objects' 
    AND policyname = 'Public can view payment screenshots'
  ) THEN
...
DROP POLICY IF EXISTS "Users can view their own audit logs" ON payment_audit_log;
DROP POLICY IF EXISTS "Service role can manage all audit logs" ON payment_audit_log;
...
-- MIGRATION COMPLETE!
-- =====================================================
-- All tables, functions, policies, and triggers created
-- You can now use the subscription system
-- =====================================================
