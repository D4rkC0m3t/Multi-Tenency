            ...
            <List>
              {notifications.map((notification, index) => (
                <React.Fragment key={notification.id}>
                  ...
                  {index < notifications.length - 1 && <Box component="hr" sx={{ border: 'none', borderTop: 1, borderColor: 'divider', m: 0 }} />}
                </React.Fragment>
              ))}
            </List>
          )}
            ...
            <List>
              {templates.map((template, index) => (
                <React.Fragment key={template.id}>
                  ...
                  {index < templates.length - 1 && <Box component="hr" sx={{ border: 'none', borderTop: 1, borderColor: 'divider', m: 0 }} />}
                </React.Fragment>
              ))}
            </List>
          )}
